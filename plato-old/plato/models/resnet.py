...
class Model(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, cut_layer=None):
        ...
        # --- START OF FIX ---
        # The model's convolutional backbone outputs 25088 features for 224x224 input
        # (7x7 feature map * 512 channels, where 512 * block.expansion is too small).
        OBSERVED_IN_FEATURES = 25088
        self.linear = nn.Linear(OBSERVED_IN_FEATURES, num_classes)
        # --- END OF FIX ---
